 ...
 */
public class LaserTower extends Point 
{
    public static int cost = 75;
    //public static double greendamage = 1, yellowdamage = 1;
    //public static double greenmaxhealth = 500, yellowmaxhealth = 500;
    //public static double greenrange = 5 * size, yellowrange = 5 * size;
    ...
    public LaserTower(int inputx, int inputy, int team)
    {
    	unit = false;
        isDead = false;
        x = inputx - width/2;
    ...
    public void draw(Graphics g, double centerdistancex, double centerdistancey, double zoom)
    {
        ...
        g.fillRect((int)(tempx + tempwidth/2 - ((double)3/(double)50) * tempsize), (int)(tempy + tempheight/2 - ((double)3/(double)50)*tempsize), (int)(((double)6/(double)50)*tempsize), (int)(((double)6/(double)50)*tempsize));
        g.setColor(Color.black);
