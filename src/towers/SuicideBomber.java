...
import javax.swing.*;
public class SuicideBomber extends Point 
{
    //public static double greenspeed = (double)3/(double)50*size, yellowspeed = (double)3/(double)50*size, greenmaxhealth = 100, yellowmaxhealth = 100, greendamage = 100, yellowdamage = 100;
    ...
    public SuicideBomber(double inputx, double inputy, int team)
    {
    	unit = true;
        x = inputx - width/2;
        y = inputy - height/2;
    ...
    public void draw(Graphics g, double centerdistancex, double centerdistancey, double zoom)
    {
        ...
        g.fillOval((int)tempx,(int)tempy,(int)tempwidth,(int)tempheight);
        if (selected)
        {
        ...
        g.drawOval((int)tempx,(int)tempy,(int)tempwidth,(int)tempheight);
