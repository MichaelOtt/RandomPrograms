 ...
 */
public class TerritoryBeacon extends Point 
{
    ...
    //public static int greenrange = 3, yellowrange = 3;
    public static double[] teammaxhealth = new double[teamnum];
    public static int[] teamrange = new int[teamnum];
    public TerritoryBeacon(int inputx, int inputy, int team)
    {
    	unit = false;
        isDead = false;
        x = inputx - width/2;
    ...
    public void draw(Graphics g, double centerdistancex, double centerdistancey, double zoom)
    {
        ...
        g.drawRect((int)(tempx + ((double)1/(double)10)*tempsize), (int)tempy, (int)(tempwidth - ((double)1/(double)5)*tempsize), (int)(tempheight));
        g.drawRect((int)tempx, (int)(tempy + ((double)1/(double)10)*tempsize), (int)(tempwidth), (int)(tempheight - ((double)1/(double)5)*tempsize));
