 ...
 */
public class LaserUnitSpawner extends Point 
{
    ...
    public LaserUnitSpawner(int inputx, int inputy, int team)
    {
    	unit = false;       
        x = inputx - width/2;
        y = inputy - height/2;
    ...
    public void update(ArrayList<Point> LaserUnits)
    {
    	double countertop;
        ...
        {
            counter = 0;
            LaserUnits.add(new LaserUnit (centerx, centery, team));
        }
    }
    ...
    {  
        ...
        g.fillRect((int)(tempx + tempwidth/2 - ((double)6/(double)50)*tempsize), (int)(tempy + tempheight/2 - ((double)6/(double)50)*tempsize), (int)((double)12/(double)50*tempsize), (int)((double)12/(double)50*tempsize));
